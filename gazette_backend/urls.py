"""
URL configuration for gazette_backend project.
...
from django.urls import path, re_path, include # manual - importar include
from django.views.generic import TemplateView # manual - importar include
